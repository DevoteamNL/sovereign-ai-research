            ...
            try:
                ...
                if source_err.had_model_response:
                    err_msg = (
                        ...
                        "This is a safety measure to prevent inaccurate information. "
            ...
            try:
                ...
                if source_err.had_model_response:
                    err_msg = (
                        ...
                        "instead of real search results. This is a safety measure to prevent "
                        "inaccurate information. Please try rephrasing your question."
                    )
                else:
                    err_msg = (
                        "The search tools did not return any results for this question. "
